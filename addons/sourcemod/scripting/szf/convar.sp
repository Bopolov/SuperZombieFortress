...
void ConVar_Init()
{
	...
	g_cvJockeyMovementVictim = CreateConVar("sm_szf_jockey_movement_victim", "0.00", "Percentage of movement speed applied to victim from jockey grab", _, true, 0.0);
	g_cvJockeyMovementAttacker = CreateConVar("sm_szf_jockey_movement_attacker", "0.120", "Percentage of movement speed applied to jockey during grab", _, true, 0.0);
